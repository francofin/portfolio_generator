...
// checkbox has different choices that can be used
...
//when accepts an object of all answers given this far, allows us to check if to continue with another action
